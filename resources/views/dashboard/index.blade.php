...
<body>
    ...
    ***********************************-->
                ...
                <ul class="contacts">
                  ...
                  <li class="active dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/dashboard/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/dashboard/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/dashboard/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
                        <span class="online_icon"></span>
                      </div>
                      <div class="user_info">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/dashboard/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
                        <span class="online_icon offline"></span>
                      </div>
                      <div class="user_info">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/dashboard/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
                        <span class="online_icon offline"></span>
                      </div>
                      <div class="user_info">
              ...
              <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                <div class="d-flex justify-content-start mb-4">
                  <div class="img_cont_msg">
                    <img src="/dashboard/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
                  </div>
                ...
                <div class="d-flex justify-content-end mb-4">
                  ...
                  <div class="img_cont_msg">
                <img src="/dashboard/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
                  </div>
                </div>
                <div class="d-flex justify-content-start mb-4">
                  <div class="img_cont_msg">
    ...
    <!--**********************************
        ...
        ***********************************-->
        ...
        <div class="main-profile">
          <div class="image-bx">
            <img src="/dashboard/images/Untitled-1.jpg" alt="">
    ...
    <!--**********************************
      ...
      <!-- <div class="form-head" style="background-image:url('/dashboard/images/background/bg3.jpg');background-position: bottom; ">
            ...
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-3 pb-0">
                    <select class="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
                      <option data-thumbnail="/dashboard/images/svg/lit3.svg">Litecoin</option>
                      <option data-thumbnail="/dashboard/images/svg/btc.svg">Ripple</option>
                      <option data-thumbnail="/dashboard/images/svg/eth.svg">Ethereum</option>
                      <option data-thumbnail="/dashboard/images/svg/btc.svg">Bitcoin</option>
                    </select>
              ...
              <div class="col-sm-6">
                <div class="card">
                  ...
                  <div class="card-body p-3 pb-0">
                    <select class="form-control custom-image-select-2 image-select mt-3 mt-sm-0">
                      <option data-thumbnail="/dashboard/images/svg/monero.svg">Monero</option>
                      <option data-thumbnail="/dashboard/images/svg/eth.svg">Ethereum</option>
                      <option data-thumbnail="/dashboard/images/svg/btc.svg">Bitcoin</option>
                      <option data-thumbnail="/dashboard/images/svg/ltc.svg">Litecoin</option>
                    </select>
                    <div class="table-responsive">
                ...
                <div class="card">
                  <div class="card-header d-sm-flex d-block pb-0 border-0">
                    ...
                    <select class="form-control custom-image-select image-select mt-3 mt-sm-0">
                      <option data-thumbnail="/dashboard/images/svg/ltc.svg">Yearly (2021)</option>
                      <option data-thumbnail="/dashboard/images/svg/eth.svg">Weekly (2021)</option>
                      <option data-thumbnail="/dashboard/images/svg/btc.svg">Daily (2021)</option>
                    </select>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                      <div class="items">
                        <div class="text-center">
                          <img class="mb-3 rounded" src="/dashboard/images/contacts/Untitled-1.jpg" alt="">
                      ...
                      <div class="items">
                        <div class="text-center">
                          <img class="mb-3 rounded" src="/dashboard/images/contacts/Untitled-2.jpg" alt="">
                      ...
                      <div class="items">
                        <div class="text-center">
                          <img class="mb-3 rounded" src="/dashboard/images/contacts/Untitled-3.jpg" alt="">
                      ...
                      <div class="items">
                        <div class="text-center">
                          <img class="mb-3 rounded" src="/dashboard/images/contacts/Untitled-4.jpg" alt="">
                      ...
                      <div class="items">
                        <div class="text-center">
                          <img class="mb-3 rounded" src="/dashboard/images/contacts/Untitled-5.jpg" alt="">
