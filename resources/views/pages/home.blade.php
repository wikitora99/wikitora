          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="more_works">
                <a class="boxed-btn3-line" href="/works">See More Works</i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="/sendmail" method="post" id="contactForm" novalidate="novalidate">
            ...
            <div class="form-group mt-3">
              <button type="submit" class="button button-contactForm btn_2 boxed-btn">Send Message &nbsp;<i class="fa fa-paper-plane"></i></button>
            </div>
          </form>
        </div>
